...
console.log(recipe);
(0, _recipeView.RecipeView).render(recipe);

},{"./model/recipeModel":"2p37Q","./view/recipeView":"7Olh7"}],"2p37Q":[function(require,module,exports) {
...
class RecipeView {
    ...
    static  #generateIngredientsMarkup(recipe1) {
        let ingredients = `
...
`;
        ...
        const markup1 = ` <div class="recipe__user-generated">
            <svg>
...
`;
    ...
    static  #renderError(message1) {
        RecipeView.#clear();
        const html1 = RecipeView.#generateErrorMarkup(message1);
        recipeContainer.insertAdjacentHTML("afterbegin", html1);
    }
}
exports.default = {
    RecipeView
...
},{}]},["fA0o9","aenu9"], "aenu9", "parcelRequire76cb")
